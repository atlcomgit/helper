 ...
 */
final class HelperCryptArrayEncodeTest extends TestCase
{
    #[Test]
    public function cryptArrayEncode(): void
    {
        $array = Helper::cryptArrayEncode(['name' => 'Иван', 'phone' => '79001112233']);
